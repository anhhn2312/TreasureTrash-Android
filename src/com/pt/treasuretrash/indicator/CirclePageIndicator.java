 ...
 */
package com.pt.treasuretrash.indicator;
...
public class CirclePageIndicator extends View implements PageIndicator {
	...
	public void setDotDistance(float mDotDistance) {
		this.mDotDistance = mDotDistance;
		invalidate();
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		final float threeRadius = mRadius * mDotDistance;// set distance between
															// dot
		...
		for (int iLoop = 0; iLoop < count; iLoop++) {
			...
			if (mOrientation == HORIZONTAL) {
				...
				dY = (mCentered == true ? (this.getHeight() / 2) : shortOffset); /*
																				 * added
																				 * by
																				 * console23
																				 */
				...
				dX = (mCentered == true ? (this.getWidth() / 2) : shortOffset); /*
																				 * added
																				 * by
																				 * console23
																				 */
