...
import com.pt.treasuretrash.slidingmenu.SlidingMenu.CanvasTransformer;
...
public class CustomViewBehind extends ViewGroup {
	...
	public void scrollBehindTo(View content, int x, int y) {
		...
		if (vis == View.INVISIBLE) {
			...
			onMenuToggleListener.onClose();
			// }
		} else if (vis == View.VISIBLE) {
			// Log.v(TAG, "behind VISIBLE");
			onMenuToggleListener.onOpen();
		}
