...
public class BadgeUtils {
	...
	public static void showNewMessages(Context context) {
		TreasureTrashDbHelper dbHelper = new TreasureTrashDbHelper(context);
		TreasureTrashSharedPreferences pref = new TreasureTrashSharedPreferences(
				context);

		int newMessage = dbHelper
				.getTotalNewMessages(pref
						.getStringValue(TreasureTrashSharedPreferences.PREF_ACCOUNT_ID));
		
		setBadge(context, newMessage);
	}
