...
package com.pt.treasuretrash.inapppurchase;
...
public class IabHelper {
	...
	public void startSetup(final OnIabSetupFinishedListener listener) {
		...
		List<ResolveInfo> listService = mContext.getPackageManager()
...
/**
	...
	void checkSetupDone(String operation) {
		if (!mSetupDone) {
			...
			Toast.makeText(mContext, "In-app billing service is not set up yet.", Toast.LENGTH_LONG).show();
			throw new IllegalStateException(
